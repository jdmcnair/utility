...
# 2. Detects DNS server on your Windows Machine.			#
# 3. Create a Shell script dynamically in your user home directory	#
# 4. Runs Shell script to fix dns issues				#
#									#
# Author : Amar Deep Singh (amar.deep.singh@mmc.com)			#
# Version: 0.2								#
# Changes in 0.2 : Made Ubuntu default and made script verbose          #
...
function GenerateShellScript($DNSAddresses,$ShellScriptPath) {
	Write-Host "Generating Shell Script to fix DNS....."
...
cd $userHome
Write-Host "Applying DNS entries and Zscaler certs, please enter your password when prompted"
